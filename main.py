    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if "download" in active_steps:
            ...
            _ = mlflow.run(
                ...
                parameters={
                    ...
                    "artifact_name": config["etl"]["raw_data_artifact"],
        ...
        if "basic_cleaning" in active_steps:
            _ = mlflow.run(
                ...
                "main",
                parameters={
                    "input_artifact": f"{config['etl']['raw_data_artifact']}:latest",
        ...
        if "data_check" in active_steps:
            _ = mlflow.run(
                ...
                "main",
                parameters={
                    "csv": f"{config['etl']['clean_data_artifact']}:latest",
                    "ref": f"{config['etl']['clean_data_artifact']}:reference",
        ...
        if "data_split" in active_steps:
            _ = mlflow.run(
                ...
                version="main",
                parameters={
                    "input": f"{config['etl']['clean_data_artifact']}:latest",
